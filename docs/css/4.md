...
#water {
  grid-column-start:3 // [!code warning]
}
```

![](/images/css/image_1681543302390.png)
...
```
![](/images/css/image_1681543588717.png)
### span
...
```
![](/images/css/image_1681543982151.png)
## grid-column-ends
### 正值
```css
#garden {
...
```
![](/images/css/image_1681543362691.png)
### 负值
>[!info]
...
```
![](/images/css/image_1681543396921.png)
...
```
![](/images/css/image_1681543412736.png)
### span
>[warning]你可以根据网格的开始和结束位置来定义一个网格项，你也可以用`span`关键词来指定你所要跨越的宽度。请注意`span`只能是正值。
```css
#garden {
  display: grid;
  grid-template-columns: 20% 20% 20% 20% 20%;
...
```
![](/images/css/image_1681543810335.png)
...
```
![](/images/css/image_1681544003919.png)
...
```
![](/images/css/image_1681544012099.png)
...
```
![](/images/css/image_1681544029114.png)
...
```
![](/images/css/image_1681544276934.png)
```css
#garden {
  display: grid;
  grid-template-columns: 20% 20% 20% 20% 20%;
...
```
![](/images/css/image_1681544537791.png)
...
```
![](/images/css/image_1681544713126.png)
...
```
![](/images/css/image_1681544996767.png)
...
```
![](/images/css/image_1681545331420.png)
## order
...
```
![](/images/css/image_1681545552130.png)
...
```
![](/images/css/image_1681545610565.png)
...
```
![](/images/css/image_1681545906228.png)
...
```
![](/images/css/image_1681546041210.png)

### 像素
>[success]`grid-template-columns`不仅仅只接受百分比的值，也接受像像素或em这样的长度单位。你甚至可以将不同的长度单位混合使用。
```css
#garden {
    display: grid;
...
```
![](/images/css/image_1681546194163.png)
...
```
![](/images/css/image_1681546359732.png)
...
```
![](/images/css/image_1681546524280.png)
...
```
![](/images/css/image_1681546704279.png)
...
```
![](/images/css/image_1681548337337.png)
